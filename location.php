...
$sql = "SELECT * FROM vehicules WHERE type = 'location' ORDER BY id DESC";
$result = $conn->query($sql);
?>

<h2 style="text-align:center;">Véhicules en location</h2>
...
while ($row = $result->fetch_assoc()) {
    ...
    echo '<p><strong>Prix :</strong> ' . htmlspecialchars($row['prix']) . ' €/jour</p>';
